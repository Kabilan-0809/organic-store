  ...
  return (
    <div className="pointer-events-none fixed bottom-20 right-6 z-40 mb-[env(safe-area-inset-bottom)] mr-[env(safe-area-inset-right)] sm:bottom-22 sm:right-8">
      <button
        ...
        className="group pointer-events-auto inline-flex items-center justify-center h-12 w-12 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 transition-all duration-300 ease-smooth hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/40 focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 focus:ring-offset-white sm:h-12 sm:w-12"
      >
        <svg
